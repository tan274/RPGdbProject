# RPG Database Management App  

This was a team project where we built the backend of a role-playing game database and a simple Python GUI to manage it.  
The database was hosted on **Google Cloud SQL (MySQL)** and the GUI was made with **Tkinter** so users could easily add, update, or search for players, characters, and items.  
